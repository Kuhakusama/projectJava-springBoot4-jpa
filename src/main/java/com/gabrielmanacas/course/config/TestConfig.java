...
import com.gabrielmanacas.course.entities.Payment;
...
import com.gabrielmanacas.course.repositories.OrderItemRepository;
...
public class TestConfig implements CommandLineRunner{
	...
	public void run(String... args) throws Exception {
		...
		OrderItem oi1 = new OrderItem(o1, p1, 2, p1.getPrice()); //pedido1,produyo1,category2,preço do produto 1.
